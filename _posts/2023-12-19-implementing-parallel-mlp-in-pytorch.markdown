...
Tensor parallel MLP is a common pattern in distributed transformer models. For instance [Parallel mlp layer](https://github.com/EleutherAI/gpt-neox/blob/9283effb37e1b72acef265d17cbe37881441e88c/megatron/model/transformer.py#L71) in GPT neox. 
